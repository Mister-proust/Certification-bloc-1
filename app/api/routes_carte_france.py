...
from Database.crud import test_fonction_sql, generalite_data, graphiques_generalites, convert_decimal, graphiques_sexe, data_sexe, data_age, graphiques_age
...
@router.get("/carte_age/{dept_code}", response_class=HTMLResponse)
